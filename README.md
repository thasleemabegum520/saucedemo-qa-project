...
|-----------------|---------------------------------------------------------------------------------------------------------|
| Test Case ID    | TC_001                                                                                                  |
| Test Case Title | Verify Login functionality with valid username and password.                                            
| Test Data       | Username:"standard_user" <br> Password: "secret_sauce"<br/>                                             |            
| Steps to follow | 1. Open Chrome.<br> 2. Go to http://saucedemo.com .<br>3.Enter username and Password.<br>4.Click Login. 
| Expected Result | user should be redirected to the inventory page of user.                                                |
|                 |                                                                     
